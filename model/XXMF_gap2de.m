...
function [output] = MF_gap2de(flag, R, params, q, t, nodes, varargin)
...
case 'check'
  ...
  elseif ~isfield(params, 'R1')
     output = 'Missing R1';
  elseif ~isfield(params, 'R2')
     output = 'Missing R2';
  else
    output = [];
 end
...
function [M] = beam_matrices(flag, R, params,x)

params.w = params.w1;
params.R = params.R1;
MB1 = MF_beam2de(flag, R, params);

params.w = params.w2;
params.R = params.R2;
MB2 = MF_beam2de(flag, R, params);
