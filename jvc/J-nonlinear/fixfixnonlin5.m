...
%net=cho_load('fixfixnonlin5.m');dq=cho_dc(net);figure(1);cho_display(net,dq);X=dq(lookup_coord(net,'b','x')),Y=dq(lookup_coord(net,'b','y')),RZ=dq(lookup_coord(net,'b','rz')) 
...
beam3dnl3 p1 [a b]  [l=50u w=6u  h=6u  oz=0+r]
beam3dnl3 p1 [b c]  [l=50u w=6u  h=6u  oz=0+r]
