...
function hjelmstad_nonlibbeam0_amf3
...
figure(1); plot(u,w); grid on; xlabel('u'); ylabel('w');
time=toc
...
function [u,w]=results(x,column_length,nstep,nu,test,ndm,num_basis_functions,num_output_points,output_interval)    
    ...
    u;         %why does this display in red and give an error?
    w;
