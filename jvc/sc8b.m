...
t1=-eval(num2str(a,'%1.10f'));
t2=-1;

t1=sc7b(W,g,z1,tol,t1,t2);

   t2=sc7b(W,g,z2,tol,t1,t2);
   G(i)=g;
   Csc(i)=H*E/pi*log(t1/t2);
%   C=(Csc(i)-Cpp(i))*L/H;
%   Csc(i)=Csc(i)+C;
%   Qsc=Csc(i)*V;
%   Qpp=Cpp(i)*V;
...
%plots 1 and 2
figure(1);plot(G,Csc,'r');xlabel('gap [m]');ylabel('C(Fringing)-red');title('C vs gap for parallel fingers');
