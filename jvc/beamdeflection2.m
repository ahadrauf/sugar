%[ux,vx,wx,rxx,ryx,rzx]=beamdeflection2(net,q,name)
...
function [ux,vx,wx,rxx,ryx,rzx]=beamdeflection2(net,q,name)
...
figure;clf;
subplot(4,1,1);plot(xx,ux);ylabel('x');title('Beam displacement x,y,z as funcitons of axial length l=0:L.');grid on;
subplot(4,1,2);plot(xx,vx);ylabel('y');grid on;
subplot(4,1,3);plot(xx,wx);ylabel('z');grid on;
