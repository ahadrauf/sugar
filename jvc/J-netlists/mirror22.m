%micromirror
%net=cho_load('mirror22.m');figure(1);cho_display(net);
%net=cho_load('mirror22.m');[q,k]=cho_dc(net);figure(1);cho_display(net,q);
%clear all;tic;net=cho_load('mirror22.m');figure(1);cho_display(net);toc
%clear all;tic;net=cho_load('mirror22.m');[q,k]=cho_dc(net);figure(1);cho_display(net,q);toc

% clear all;tic;net=cho_load('mirror22.m');[q,k]=cho_dc(net);figure(1);cho_display(net,q);toc,theta=q(lookup_coord(net,'plate_top','rx')),cosine=q(lookup_coord(net,'bridgecenter','y'))
