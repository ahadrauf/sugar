...
% clear all;tic;net=cho_load('mirror20.m');[q,k]=cho_dc(net);figure(1);cho_display(net,q);toc,theta=q(lookup_coord(net,'plate_top','rx')),cosine=q(lookup_coord(net,'bridgecenter','y'))
...
predisplacedbeam4 layer1 [bridgecenter disp2][l=l_predisp w=w_predisp h=h_predisp qox1=0 qoy1=0 qoz1=0 qx2=0 qy2=y2_disp qz2=0 qox2=0 qoy2=0 qoz2=0 L1=displink oz1=pi/2-pi/8] 
