...
perforated_subnet7 p1 [a(1) b(1) left right A B][numberholes=2 w=20u h=15u l=200u whorizontal=5u wvertical=5u] 

beam3d p1 [ A aa ] [l=7.5u  w=10u h=100u oz=-pi/2]
beam3d p1 [ B aa ] [l=7.5u  w=10u h=100u oz=pi/2]

%beam3d p1 [ aa aaa ] [l=47.5u  w=100u h=100u oz=pi/2]
%beam3d p1 [ aa bbb ] [l=47.5u  w=100u h=100u oz=-pi/2]

%beam3d p1 [ A aaa ] [l=40u  w=100u h=100u oz=pi/2]
%beam3d p1 [ B bbb ] [l=40u  w=100u h=100u oz=-pi/2]
