%micromirror
%net=cho_load('mirror12.m');figure(1);cho_display(net);
%net=cho_load('mirror12.m');[q,k]=cho_dc(net);figure(1);cho_display(net,q);
%clear all;tic;net=cho_load('mirror12.m');figure(1);cho_display(net);toc
%clear all;tic;net=cho_load('mirror12.m');[q,k]=cho_dc(net);figure(1);cho_display(net,q);toc
