...
circbeam12 p1 [b d][w=W h=H radius=100u alpha=pi/4 oz=-pi/4] 
circbeam12 p1 [d a][w=W h=H radius=100u alpha=pi/4 oz=0] 

circbeam12 p1 [b1 b2][w=W h=H radius=100u alpha=pi/4/2 oz=-pi/4] 
