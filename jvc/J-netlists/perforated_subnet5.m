...
subnet perforated_subnet5 [aa bb A B][numberholes=* w=* h=* l=* whorizontal=* wvertical=*] 
[
   ...
   %Make left end
   beam3dlink parent [a(1) aa][l=LV/2 w=wvertical h=h L1=whorizontal/2 L2=wvertical/2 oz2=-pi/2 oz=-pi/2] %Vertical.
   beam3dlink parent [aa b(1)][l=LV/2 w=wvertical h=h L1=wvertical/2 oz1=pi/2 L2=whorizontal/2 oz=-pi/2] %Vertical.
   %Make right end
   ...
   beam3dlink parent [A bb][l=LV/2 w=wvertical h=h L1=whorizontal/2 L2=wvertical/2 oz2=pi/2 oz=-pi/2] %Vertical.   
   beam3dlink parent [bb B][l=LV/2 w=wvertical h=h L1=wvertical/2 oz1=-pi/2 L2=whorizontal/2 oz=-pi/2] %Vertical.   
]
