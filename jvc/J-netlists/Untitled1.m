...
param ox=0, oy=0, oz=0, resolution=10

subnet predisplacedbeamdiscrete [n(1) n(11)] []
[
   ...
   [
      ...
      %discretized beam   
      beam3d parent [n(k) n(k+1)][l=(L+qx2-qx1)/resolution w=w h=h ox=ox oy=oy oz=oz]    
%     pos    *      [o n(i)]   [y=1 x=i]
%     pos    *      [o n(i+1)] [y=i x=l]
...
predisplacedbeamdiscrete p1 [node1 node2] [ox=ox oy=oy oz=oz]
