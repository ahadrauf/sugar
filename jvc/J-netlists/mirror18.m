...
anchor p1 [disp1][l=50u h=highSCS w=100u ]  
predisplacedbeam4 p1 [comb5        disp2][l=l_predisp w=w_predisp h=h_predisp qox1=0 qoy1=0 qoz1=0 qx2=0 qy2=y2_disp qz2=0 qox2=0 qoy2=0 qoz2=0 L1=displink oz1=pi/2-pi/8] 
anchor p1 [disp2][l=50u h=highSCS w=100u ]  
...
f3d * [bridgecenter][F=1000u oz=-pi/2]
