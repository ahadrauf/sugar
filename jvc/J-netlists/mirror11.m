%micromirror
%net=cho_load('mirror11.m');figure(1);cho_display(net);
%net=cho_load('mirror11.m');[q,k]=cho_dc(net);figure(1);cho_display(net,q);
%clear all;tic;net=cho_load('mirror11.m');figure(1);cho_display(net);toc
%clear all;tic;net=cho_load('mirror11.m');[q,k]=cho_dc(net);figure(1);cho_display(net,q);toc
...
h_perf=highSCS
perforatedcomb p1 [leftcomb1 comb1][numberfingers=numberfingers w=w_perf h=h_perf whorizontal=whorizontal wfinger=w_finger lfinger=l_finger gap=gap] 
