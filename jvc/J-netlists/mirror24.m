%micromirror
%net=cho_load('mirror23.m');figure(1);cho_display(net);
%net=cho_load('mirror23.m');[q,k]=cho_dc(net);figure(1);cho_display(net,q);
%clear all;tic;net=cho_load('mirror23.m');figure(1);cho_display(net);toc
%clear all;tic;net=cho_load('mirror23.m');[q,k]=cho_dc(net);figure(1);cho_display(net,q);toc

% clear all;tic;net=cho_load('mirror23.m');[q,k]=cho_dc(net);figure(1);cho_display(net,q);toc,theta=q(lookup_coord(net,'plate_top','rx')),cosine=q(lookup_coord(net,'bridgecenter','y'))
...
%f3d * [bridgecenter][F=(12^2)*(0.13e-6) oz=-pi/2]
%f3d * [bridgecenter][F=(25^2)*(0.13e-6) oz=-pi/2]
%f3d * [bridgecenter][F=(37^2)*(0.13e-6) oz=-pi/2]
...
%f3d * [bridgecenter][F=(130^2)*(0.13e-6) oz=-pi/2]
%f3d * [bridgecenter][F=(140^2)*(0.13e-6) oz=-pi/2]
%f3d * [bridgecenter][F=(150^2)*(0.13e-6) oz=-pi/2]

%f3d * [bridgecenter][F=(80^2)*(0.13e-6) oz=-pi/2]

f3d * [bridgecenter][F=(v^2)*(0.13e-6) oz=-pi/2]

%f3d * [bridgecenter][F=800u oz=-pi/2] 

V=100 %100V is 12.6 theta
numberfingers=80*8 %70fingers
fingerheight=50u
gap=3u
...
beam3d layer1 [plate_left plate_right][l=350u w=200u h=50u]
