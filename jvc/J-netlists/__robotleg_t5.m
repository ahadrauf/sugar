%net=cho_load('__robotleg_t5.m');figure(1);cho_display(net);
...
H=2u
W=20u
anchor p1 [thR]   [l=10u w=10u h=10u oz=pi oz=pi/2] 
anchor p1 [thL]   [l=10u w=10u h=10u oz=pi oz=pi/2] 
%beam3d p1 [thL ALl] [l=L w=W h=H oy=-pi/2 ox=pi/2] 
%beam3d p1 [thR ALr] [l=L w=W h=H oy=pi/2 ox=pi/2] 

%body
beam3d p1 [ar thR] [l=30u w=50u h=20u ox=pi/2] 
beam3d p1 [al thL] [l=30u w=50u h=20u ox=pi/2] 
beam3d p1 [arr ar] [l=500u w=400u h=20u ox=pi/2] 
beam3d p1 [all al] [l=500u w=400u h=20u ox=pi/2] 
...
RS_qoy2=0
RS_qoz2=0
predisplacedbeam4 p1 [thR ALr] [l=L w=W h=H oy=pi/2 ox=pi/2   
...
RS_qoy2=0
RS_qoz2=0
predisplacedbeam4 p1 [thL ALl] [l=L w=W h=H oy=-pi/2 ox=pi/2 
    qx1  = RS_qx1 	    qy1  = RS_qy1 		qz1  = RS_qz1    
    qox1 = RS_qox1 	    qoy1 = RS_qoy1 	    qoz1 = RS_qoz1 
    qx2  = RS_qx2 	    qy2  = RS_qy2 		qz2  = RS_qz2    
    qox2 = RS_qox2     qoy2 = RS_qoy2	    qoz2 = RS_qoz2 ]
...
%body hinge
%beam3d p1 [anchL ALl] [l=200u w=wh h=hh oy=-pi/2] 
%beam3d p1 [anchR ALr] [l=200u w=wh h=hh oy=-pi/2] 
...
tw=3u
th=3u
anchor p1 [T1]   [l=10u w=10u h=10u oz=pi ox=pi/2] 
%anchor p1 [T2]   [l=10u w=10u h=10u oz=pi ox=pi/2] 
