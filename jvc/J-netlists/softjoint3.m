% net=cho_load('softjoint3.m');[q]=cho_dc(net);figure(1);cho_display(net,q);q(lookup_coord(net,'C','y'))
% net=cho_load('softjoint3.m');[q]=cho_dc(net);figure(1);cho_display(net,q);
% net=cho_load('softjoint3.m');figure(1);cho_display(net);
