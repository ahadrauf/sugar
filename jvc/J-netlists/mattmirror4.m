%running commands
%net=cho_load('mattmirror4.m');figure(1);cho_display(net);
%net=cho_load('mattmirror4.m');q=cho_dc(net);figure(1);cho_display(net,q); 
%things to vary
...
%process file
uses mumps.net %E=185GPa

%constants
nfingers=79+2 %number of fingers --> DOF=10,026 for 79+2 fingers
%nfingers=19+2 %number of fingers --> DOF=10,026 for 79+2 fingers
...
[
   ...
   beam3d p1 [cmb5 cmb6][l=cmblink*1.2 w=wthick h=hthick oz=180] %little extention
   %end right crab
