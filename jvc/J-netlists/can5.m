%net=cho_load('can4.m');q=cho_dc(net);figure(1);cho_display(net);  
%f=5e-6;i=1;k(i,1)=f/q(lookup_coord(net,'F','x'));k(i,2)=f/q(lookup_coord(net,'F','y'));k(i,3)=f/q(lookup_coord(net,'F','rz')) 
uses mumps2.net
