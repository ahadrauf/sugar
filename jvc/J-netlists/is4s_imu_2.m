...
beam3d p1 [c(9) b(9)][l=W2*3 w=W2 h=H oz=-pi/2] %coupling  
pL = 250u
for i = 1 : 4 % 3 9
[
    beam3d p1 [b(8+i) b(9+i)][l=W2 w=W2 h=H oz=-pi/2] %coupling  
    beam3dlink p1 [b(9+i) bL(9+i)][l=pL w=W*2 h=H oz=0] 
    anchor p1 [bL(9+i)][l=aL w=aL h=H oz=0] %anchor
    beam3dlink p1 [b(9+i) bR(9+i)][l=pL w=W*2 h=H oz=pi] 
    anchor p1 [bR(9+i)][l=aL w=aL h=H oz=pi] %anchor
]
beam3d p1 [c(3) t(3)][l=W2*3 w=W2 h=H oz=pi/2] %coupling  
pL = 250u
for i = 1 : 4 % 3 9
[
    beam3d p1 [t(2+i) t(3+i)][l=W2 w=W2 h=H oz=pi/2] %coupling  
    beam3dlink p1 [t(3+i) tL(3+i)][l=pL w=W*2 h=H oz=0] 
    anchor p1 [tL(3+i)][l=aL w=aL h=H oz=0] %anchor
    beam3dlink p1 [t(3+i) tR(3+i)][l=pL w=W*2 h=H oz=pi] 
    anchor p1 [tR(3+i)][l=aL w=aL h=H oz=pi] %anchor
]
...
f=4.7
f3d * [c(3)][F=f*600e-6 oz=pi/2] 
f3d * [c(9)][F=f*600e-6 oz=pi/2] 
