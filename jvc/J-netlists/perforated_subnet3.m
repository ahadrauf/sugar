...
%   LV=w-whorizontal*2
   ...
   %Make left end
      beam3dlinkcorner parent [leftA  a(1)][l=LH w=whorizontal h=h L1=wvertical/2] %Horizontal.
      beam3dlinkcorner parent [leftB  b(1)][l=LH w=whorizontal h=h L1=wvertical/2] %Horizontal.
      beam3dlink parent [leftA  leftB][l=LV w=wvertical h=h*H L1=whorizontal/2 L2=whorizontal/2 oz=-pi/2] %Vertical.
      beam3dlink parent [a(1)  b(1)][l=LV w=wvertical h=h*H L1=whorizontal/2 L2=whorizontal/2 oz=-pi/2] %Vertical.
   ...
   %Make right end
   beam3dlinkcorner parent [a(numberholes) rightA][l=LH w=whorizontal h=h L2=wvertical/2] %Horizontal.
   beam3dlinkcorner parent [b(numberholes) rightB][l=LH w=whorizontal h=h L2=wvertical/2] %Horizontal.
