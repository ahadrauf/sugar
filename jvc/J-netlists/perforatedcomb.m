...
subnet perforatedcomb [left right][numberfingers=* w=* h=* whorizontal=* wfinger=* lfinger=* gap=* wvertical=* L1=* L2=*] 
[
   ...
   %Make left end
   beam3dlink parent [a(1) left][l=LV/2 w=wvertical h=h L1=whorizontal/2 L2=wvertical/2+L2 oz2=-pi/2 oz=-pi/2] %Vertical.
   ...
   beam3dlink parent [right b(numberholes+1)][l=LV/2 w=wvertical h=h L1=L1+wvertical/2 oz1=-pi/2 L2=whorizontal/2 oz=-pi/2] %Vertical.   
