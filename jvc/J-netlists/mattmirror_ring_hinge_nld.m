...
%running commands
%tic;net=cho_load('mattmirror_ring_hinge_nld.m');load=toc,tic;dq=cho_dc(net);dc=toc,figure(1);tic;cho_display(net,dq);dsp=toc,dof=net.dof,rotation=dq(lookup_coord(net,'anon82.r0','ry'))*180/pi
%tic;net=cho_load('mattmirror_ring_hinge_nld.m');figure(1);cho_display(net);loadanddispay=toc
...
[
   %ring
   beam3d p1 [r0 r1][l=R w=wthick*100 h=hthick oz=-90]
   beam3d p1 [r0 r2][l=R w=wthick*100 h=hthick oz=0]
   beam3d p1 [r0 r3][l=R w=wthick*100 h=hthick oz=90]
   beam3d p1 [r0 r4][l=R w=wthick*100 h=hthick oz=180]
