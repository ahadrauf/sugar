...
%running commands
%tic;net=cho_load('mattmirror_ring_hinge_d.m');load=toc,tic;dq=cho_dc(net);dc=toc,figure(1);tic;cho_display(net,dq);dsp=toc,dof=net.dof
%rotation=dq(lookup_coord(net,'anon82.r0','ry'))*180/pi
%tic;net=cho_load('mattmirror_ring_hinge_d.m');figure(1);cho_display(net);loadanddispay=toc
