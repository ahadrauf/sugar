...
function [output] = MF_rigidlinkbeamcloaked(flag, R, param, q, t, nodes, varargin);
...
if ~isfield(param,'oy1'),oy1=0; %link orientations
else, oy1=param.oy1; end
if ~isfield(param,'oy2'),oy2=0;
else, oy2=param.oy2; end
if ~isfield(param,'oz1'),oz1=0;
else, oz1=param.oz1; end
if ~isfield(param,'oz2'),oz2=0;
else, oz2=param.oz2; end
...
if isfield(param,'L1'),L1=param.L1;
else,L1=0;end
if isfield(param,'L2'),L2=param.L2;
else,L2=0;end  
if ~isfield(param,'oy1'),oy1=0; %link orientations
else, oy1=param.oy1; end
if ~isfield(param,'oy2'),oy2=0;
...
a2=rot2local(0,oy2,oz2)'*[L2;0;0];
  ...
  output = R * [0 a1(1)+a2(1)+param.l;
                0 a1(2)+a2(2);
                0 a1(3)+a2(3)];            

case 'display'

  displayrigidlinkbeamcloaked(q, nodes(1).pos, R, param);
