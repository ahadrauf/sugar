...
function [output] = MF_freehinge(flag, R, param, q, t, nodes, varargin);
...
%   abs((J2-J)/J)
   ...
   Iy =0*	W * H^3 / 12;		%Moment about y.
   Iz =0*	H * W^3 / 12;		%Moment about z. Used in 2D.
...
case 'display'
   q(5)=-1.3*asin((q(9)-q(3))/param.l);
   q(6)=1.3*asin((q(8)-q(2))/param.l);
   q(11)=q(5);q(12)=q(6);
%   q(11)=0;q(12)=0;
%   q(5)=0;q(6)=0;
%   R=rot2local(0,asin((q(9)-q(3))/param.l),asin((q(8)-q(2))/param.l))*R;
