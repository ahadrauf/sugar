...
case 'K'
   ...
   delta1=1/(psi11*psi66*psi22-psi11*psi26^2-psi66*psi12^2+2*psi12*psi16*psi26-psi16^2*psi22);
   k(1,1)=(psi22*psi66-psi26^2)*delta1;
   k(1,2)=(psi12*psi66-psi16*psi26)*delta1;
   k(1,6)=(psi12*psi26-psi16*psi22)*delta1;
   k(2,1)=(psi12*psi66-psi16*psi26)*delta1;
   k(2,2)=(psi66*psi11-psi16^2)*delta1;
   k(2,6)=(psi26*psi11-psi12*psi16)*delta1;
   k(6,1)=(psi12*psi26-psi16*psi22)*delta1;
   k(6,2)=(psi26*psi11-psi12*psi16)*delta1;
   ...
   k(8,7)=-k(7,1);
   k(12,7)=-k(12,1);
   k(12,1)=-k(1,1)*R*sin(lambda)-k(2,1)*R*(1-cos(lambda))-k(6,1);
   k(12,2)=-k(2,1)*R*sin(lambda)-k(2,2)*R*(1-cos(lambda))-k(6,2);
   ...
   delta2=1/(psi33*psi55*psi44-psi33*psi45^2-psi55*psi34^2+2*psi34*psi35*psi45-psi35^2*psi44);
   k(3,3)=(psi44*psi55-psi45^2)*delta2;
   k(3,4)=(psi34*psi55-psi35*psi45)*delta2;
   k(3,5)=(psi34*psi45-psi35*psi44)*delta2;
   k(4,3)=(psi34*psi55-psi35*psi45)*delta2;
   k(4,4)=(psi55*psi33-psi35^2)*delta2;
   k(4,5)=(psi45*psi33-psi34*psi35)*delta2;
   k(5,3)=(psi34*psi45-psi35*psi44)*delta2;
   k(5,4)=(psi45*psi33-psi34*psi35)*delta2;
   ...
   k(11,10)=k(5,4);
   k(11,11)=k(5,5);
   k(9,3)=-k(4,3)*R*sin(lambda)-k(5,3)*R*(1-cos(lambda))-k(3,3);
   k(9,4)=-k(4,4)*R*sin(lambda)-k(5,4)*R*(1-cos(lambda))-k(4,3);
   k(9,5)=-k(5,4)*R*sin(lambda)-k(5,5)*R*(1-cos(lambda))-k(5,3);
   k(9,9)=-k(9,4)*R*sin(lambda)-k(10,5)*R*(1-cos(lambda))-k(9,3);
   k(10,9)=-k(10,4)*R*sin(lambda)-k(10,5)*R*(1-cos(lambda))-k(10,3);
   k(11,9)=-k(11,4)*R*sin(lambda)-k(11,5)*R*(1-cos(lambda))-k(11,3);
...
%   q(12)=q(12)+oz2;
   ...
   displaycircbeam(q, nodes(1).pos, R, L, param.w, param.h, param.radius, param.alpha);
