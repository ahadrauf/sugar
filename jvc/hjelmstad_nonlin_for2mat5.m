...
aa=1.6102e+003;
if ((A(1,1) > 1.6e+003) & (A(1,1) < 1.7e+003)) 
A11=A(1,1)
i,j
z,column_length
hj,dhj,hi,dhi
m,n,mm,nn
weight_factor, num_basis_functions
bgb=BGB(m,n)
Xbasis(i,z,column_length,num_basis_functions);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Xbasis(i,z,column_length,num_basis_functions) %Evaluate ith basis function h and derivative dh at point z  
    n = mod(i,2)
    m = i/2 + n
    atan1=atan(1)
    a = (2*m-1)*2*atan(1)
