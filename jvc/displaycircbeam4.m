...
%Modified by Jason Vaughn Clark, Oct/2001
%Modified by Jason Vaughn Clark, Nov/2001
...
for corner=1:4 %The four rectangular corners of the cross section, A.
   ...
   for i=1:resolution %Pick a sample point to rotate and position along the bowl contour.
      p(:,i)=rot2global(rx1G*(1-f(i)),ry1G*(1-f(i)),rz1G*(1-f(i)))*rot2global(rx2G*f(i),ry2G*f(i),rz2G*f(i))*...         
             (R*... %Rotate to global.
      ...
      p(:,i)=rot2global(rx1G*0,ry1G*0,rz1G*0)*...
