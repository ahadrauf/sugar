...
%[OL,F_X,F_Y,cap,total_charge_on_seg2,F_pp,cap_pp,Q_pp,Q,rhs,lhs,bhs,ths]=obj_slot;
%[OL2,F_X2,F_Y2,cap2,total_charge_on_seg22,F_pp2,cap_pp2,Q_pp2,Q2,rhs,lhs,bhs,ths]=obj_comb;
%[gap1,F_X1,F_Y1,cap1,total_charge_on_seg21,F_pp1,capacitance_pp1,Q_pp1,Q1,rhs,lhs,bhs,ths]=obj_gap;
%figure(3);plot(gap1*1e-6,F_X1,'r',OL*1e-6,F_X,'b',OL2*1e-6,-F_X2,'k');grid on;xlabel('overlap [m]');ylabel('force  [N]');title('2um x 2um, V=50V, L=40um');
