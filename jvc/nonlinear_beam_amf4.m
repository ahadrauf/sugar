...
%The following known input/output is a test for the program to check its accuracy
%input:
...
for nstep=1:num_load_steps   
    ...
    figure(1); hold on; plot(u,w); grid on; xlabel('u'); ylabel('w'); title('Nonlinear beam. Distributed loading');
