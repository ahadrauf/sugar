...
[
    ...
    shuttle(1) beam2de_b p1 [shaft_gap_stop shaft(1)] [l=121.857u-68.833u w=20u oz=pi/2+rot Rs=10]
    for k=1:N [
        ...
        gca_right(k) gap2de_f p1 [gca_shaft_attachment_node_right(k+1) gca_shaft_finger_end_right(k+1) gca_anchor_finger_end_right(k+1) gca_anchor_attachment_node_right(k+1)] [l=76.472u w1=5.005u-0.96u w2=5.005u-0.96u oz=rot gap=4.834u R1=100 R2=100 Rs=10 R_insulator=100 V=V h=550u]
        gca_left(k) gap2de_f p1 [gca_anchor_finger_end_left(k+1) gca_anchor_attachment_node_left(k+1) gca_shaft_attachment_node_left(k+1) gca_shaft_finger_end_left(k+1)] [l=76.472u w1=5.005u-0.96u w2=5.005u-0.96u oz=rot+pi gap=4.834u R1=100 R2=100 Rs=10 R_insulator=100 V=V h=550u]
    ...
    % angled arm
    beam2de_b p1 [nj pj] [l=Larm w=warm oz=ang Rs=10]
...
%     gap_stop_suspension_left(1) beam2de_b p1 [shaft_gap_stop_left gap_stop_suspension_point_left(1)] [l=100u w=1n oz=rot-pi Rs=10]
%     gap_stop_suspension_left(2) beam2de_b p1 [gap_stop_suspension_point_left(1) gap_stop_suspension_point_left(2)] [l=30u+3.833u w=1n oz=rot-pi/2 Rs=10]
%     gap_stop_suspension_left(3) beam2de_b p1 [gap_stop_suspension_point_left(2) gap_stop_left_anchor] [l=100u+40u w=1n oz=rot Rs=10]
%     gap_stop_suspension_right(1) beam2de_b p1 [shaft_gap_stop_right gap_stop_suspension_point_right(1)] [l=100u w=1n oz=rot Rs=10]
%     gap_stop_suspension_right(2) beam2de_b p1 [gap_stop_suspension_point_right(1) gap_stop_suspension_point_right(2)] [l=30u+3.833u w=1n oz=rot-pi/2 Rs=10]
%     gap_stop_suspension_right(3) beam2de_b p1 [gap_stop_right_anchor gap_stop_suspension_point_right(2)] [l=100u+80u w=1n oz=rot Rs=10]  % TODO: Why is this > +40u on the other side?
